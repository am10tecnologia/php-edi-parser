...
class ROAntecipedDebitDetailRegister extends BaseRegister
{
    ...
    public function __construct()
    {
        ...
        $this->addField(new RegisterField('data_pagamento_ro_antecipado', 'D', 41, 48, 8, true, 'AAAAMMDD – Data de Pagamento do RO Antecipado.', '0'));      
        $this->addField(new RegisterField('sinal_valor_ro_antecipado', 'N', 49, 49, 1, true, '+ = credito, - = debito.', '0'));
        $this->addField(new RegisterField('valor_ro_antecipado', 'F', 50, 62, 13, true, 'Valor do RO antecipado.', '0'));
        ...
        $this->addField(new RegisterField('data_pagamento_ajuste', 'D', 92, 99, 8, true, 'AAAAMMDD.', '0'));       
        $this->addField(new RegisterField('sinal_valor_ajuste_debito', 'N', 100, 100, 1, true, '+ = credito, - = debito.', '0'));
        $this->addField(new RegisterField('valor_ajuste_debito', 'F', 101, 113, 13, true, 'Valor total do débito.', '0'));
        $this->addField(new RegisterField('sinal_valor_compensado', 'N', 114, 114, 1, true, '+ = credito, - = debito.', '0'));
        $this->addField(new RegisterField('valor_compensado', 'F', 115, 127, 13, true, 'Valor compensado do RO antecipado.', '0'));
        $this->addField(new RegisterField('sinal_valor_saldo_ro_antecipado', 'N', 128, 128, 1, true, '+ = credito, - = debito.', '0'));
        $this->addField(new RegisterField('valor_saldo_ro_antecipado', 'F', 129, 141, 13, true, 'Resultado do total de débito – valor compensado.', '0'));         
    }
