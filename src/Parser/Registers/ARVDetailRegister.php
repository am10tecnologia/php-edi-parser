...
class ARVDetailRegister extends BaseRegister
{
    ...
    public function __construct()
    {
        ...
        $this->addField(new RegisterField('data_credito', 'D', 21, 28, 8, true, 'AAAAMMDD – Data de pagamento da operação.', '0'));
        $this->addField(new RegisterField('sinal_valor_bruto_antec_avista', 'N', 29, 29, 1, true, '+ = credito, - = debito.', '0'));
        $this->addField(new RegisterField('valor_bruto_antec_avista', 'F', 30, 42, 13, true, 'Valor bruto da antecipação de agenda à vista.', '0'));
        $this->addField(new RegisterField('sinal_valor_bruto_antec_parcelado', 'N', 43, 43, 1, true, '+ = credito, - = debito.', '0'));
        $this->addField(new RegisterField('valor_bruto_antec_parcelado', 'F', 44, 56, 13, true, 'Valor bruto da antecipação de agenda do parcelado.', '0'));
        $this->addField(new RegisterField('sinal_valor_bruto_antec_electron_pre', 'N', 57, 57, 1, true, '+ = credito, - = debito.', '0'));
        $this->addField(new RegisterField('valor_bruto_antec_electron_pre', 'F', 58, 70, 13, true, 'Valor bruto da antecipação da agenda do Electron Pré-Datado.', '0'));
        $this->addField(new RegisterField('sinal_valor_bruto_antec_total', 'N', 71, 71, 1, true, '+ = credito, - = debito.', '0'));
        $this->addField(new RegisterField('valor_bruto_antec_total', 'F', 72, 84, 13, true, 'Valor bruto da antecipação das agendas à vista, parcelado e Electron Pré-Datado.', '0'));
        $this->addField(new RegisterField('sinal_valor_liquido_antec_avista', 'N', 85, 85, 1, true, '+ = credito, - = debito.', '0'));
        $this->addField(new RegisterField('valor_liquido_antec_avista', 'F', 86, 98, 13, true, 'Valor líquido da antecipação da agenda à vista.', '0'));
        $this->addField(new RegisterField('sinal_valor_liquido_antec_parcelado', 'N', 99, 99, 1, true, '+ = credito, - = debito.', '0'));
        $this->addField(new RegisterField('valor_liquido_antec_parcelado', 'F', 100, 112, 13, true, 'Valor líquido da antecipação da agenda do parcelado.', '0'));
        $this->addField(new RegisterField('sinal_valor_liquido_antec_pre', 'N', 113, 113, 1, true, '+ = credito, - = debito.', '0'));
        $this->addField(new RegisterField('valor_liquido_antec_pre', 'F', 114, 126, 13, true, 'Valor líquido da antecipação da agenda do parcelado.', '0'));
        $this->addField(new RegisterField('sinal_valor_liquido_total', 'N', 127, 127, 1, true, '+ = credito, - = debito.', '0'));
        $this->addField(new RegisterField('valor_liquido_total', 'F', 128, 140, 13, true, 'Valor líquido da antecipação das agendas à vista, parcelado e Electron Pré-Datado.', '0'));
        $this->addField(new RegisterField('taxa_desconto_antec', 'F', 141, 145, 5, true, 'Taxa de desconto comercial da antecipação.', '0'));
        ...
        $this->addField(new RegisterField('valor_liquido_antec', 'F', 170, 182, 13, true, 'Valor líquido da antecipação.', '0'));       
    }
