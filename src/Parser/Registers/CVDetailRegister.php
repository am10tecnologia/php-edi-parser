...
class CVDetailRegister extends BaseRegister
{
    ...
    public function __construct()
    {
        ...
        $this->addField(new RegisterField('data_venda', 'N', 38, 45, 8, true, 'AAAAMMDD – Data em que a venda ou o ajuste foi realizado.', '0'));
        $this->addField(new RegisterField('sinal_valor_compra', 'N', 46, 46, 1, true, '+ = credito, - = debito.', '0'));
        $this->addField(new RegisterField('valor_compra', 'N', 47, 59, 13, true, 'Valor da compra ou da parcela que foi liberada, no caso de venda parcelada na loja.', '0'));
        ...
        $this->addField(new RegisterField('valor_complementar', 'N', 99, 111, 13, true, 'Valor da transação de Saque com cartão de Débito ou AgroElectron de acordo com indicador de produto do RO.', '0'));
        $this->addField(new RegisterField('dig_cartao', 'N', 112, 113, 2, true, 'Número de Dígitos do Cartão.', '0'));
        $this->addField(new RegisterField('valor_total_venda', 'N', 114, 126, 13, true, 'O valor total da venda parcelada na loja.', '0'));
        $this->addField(new RegisterField('valor_proxima_parcela', 'N', 127, 139, 13, true, 'O valor das próximas parcelas da venda é enviado somente no arquivo de vendas.', '0'));
        ...
        $this->addField(new RegisterField('hora_transacao', 'N', 183, 188, 6, true, 'Hora da transação apresentada no formado HHMMSS.', '0'));
