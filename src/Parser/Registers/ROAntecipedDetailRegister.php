...
class ROAntecipedDetailRegister extends BaseRegister
{
    ...
    public function __construct()
    {
        ...
        $this->addField(new RegisterField('data_vencimento', 'D', 21, 28, 8, true, 'AAAAMMDD – Data de pagamento da operação.', '0'));
        ...
        $this->addField(new RegisterField('valor_bruto_orig_ro', 'F', 41, 53, 13, true, 'Valor bruto original do RO..', '0'));
        $this->addField(new RegisterField('sinal_valor_liquido_orig_ro', 'N', 54, 54, 1, true, '+ = credito, - = debito.', '0'));
        $this->addField(new RegisterField('valor_liquido_orig_ro', 'F', 55, 67, 13, true, 'Valor líquido Original do RO.', '0'));
        $this->addField(new RegisterField('sinal_valor_bruto_antec_ro', 'N', 68, 68, 1, true, '+ = credito, - = debito.', '0'));
        $this->addField(new RegisterField('valor_bruto_antec_ro', 'F', 69, 81, 13, true, 'Valor líquido original do RO, exceto se houver débitos programados para este RO.', '0'));
        $this->addField(new RegisterField('sinal_valor_liquido_antec_ro', 'N', 82, 82, 1, true, '+ = credito, - = debito.', '0'));
        $this->addField(new RegisterField('valor_liquido_antec_ro', 'F', 83, 95, 13, true, 'Valor líquido efetivamente pago ao estabelecimento, já descontada a taxa de desconto comercial da antecipação.', '0'));
